"""In-memory seed data for SentinelShop. Deterministic; reset via /__reset."""
...
INITIAL_USERS: Dict[int, Dict[str, Any]] = {
    1: {
        ...
        "creditScore": 780, "token": "token-alice-12345",
    },
    2: {
        "id": 2, "username": "bob", "email": "bob@example.com", "role": "user",
        "passwordHash": "$2b$12$d8X5k8l9bobpasswordhashsalt888",
        "internalNotes": "Account flagged for manual KYC review",
        "creditScore": 620, "token": "token-bob-67890",
    },
    9: {
        "id": 9, "username": "admin", "email": "admin@sentinelshop.local", "role": "admin",
        "passwordHash": "$2b$12$k9Z1k8l9adminpasswordhashsalt777",
        "internalNotes": "Root superadministrator account",
        "creditScore": 850, "token": "token-admin-99999",
    },
}

INITIAL_ORDERS: Dict[int, Dict[str, Any]] = {
...
INITIAL_INVOICES: Dict[int, Dict[str, Any]] = {
